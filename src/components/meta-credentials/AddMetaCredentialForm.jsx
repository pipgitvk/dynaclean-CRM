...
export default function AddMetaCredentialForm({
  backPath,
  cancelPath,
  successRedirectPath,
}) {
    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Add a new Meta Facebook Lead credential and configure form-specific lead distribution
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
            />
            <p className="mt-1 text-sm text-gray-500">The ID of your Facebook Page</p>
          </div>
