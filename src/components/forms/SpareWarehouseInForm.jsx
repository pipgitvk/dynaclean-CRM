...
export default function SpareWarehouseInForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success("Spare stock received successfully!");
        ...
        setFiles({ received_image: null, supporting_doc: null });
        document
  ...
  return (
    ...
    >
      <h3 className="text-lg font-semibold mb-4">
        Spare Warehouse In - Receive Stock
      </h3>
      ...
      {!showForm && (
        <div>
          ...
          <div className="hidden sm:block overflow-auto border rounded-lg mt-2">
            {pendingRequests.length === 0 ? (
              <p className="text-sm text-gray-500 p-3">No pending requests available</p>
            ) : (
              <table className="w-full text-sm">
                <thead className="bg-gray-100 sticky top-0">
                  <tr>
                    <th className="p-2 text-left">Req ID</th>
                    <th className="p-2 text-left">Spare Image</th>
                    <th className="p-2 text-left">Spare Name</th>
                    <th className="p-2 text-left">Quantity</th>
                    <th className="p-2 text-left">From Company</th>
                ...
                <tbody>
                  {pendingRequests.map((req) => (
                    ...
                    >
                      ...
                      <td className="p-2">
                        <img src={req.spare_image} alt={req.spare_name} className="w-16 h-16 object-cover" />
                      </td>
                      <td className="p-2">{req.spare_name}</td>
          ...
          <div className="bg-gray-50 p-4 rounded border">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  value={selectedRequest.spare_id}
                  disabled
              ...
              <div>
                ...
                <input
                  value={selectedRequest.spare_name}
                  disabled
                  className="w-full border p-2 rounded bg-white"
                />
              </div>
