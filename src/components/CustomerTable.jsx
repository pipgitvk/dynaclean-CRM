...
export default function CustomerTable({ customers, isLoading }) {
  ...
  // searchQuery is the applied filter; inputValue is the text in the input
  ...
  // Only update applied search when pressing the Search button
    ...
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex w-full md:max-w-sm gap-2">
          ...
          <button
            onClick={applySearch}
            className="whitespace-nowrap bg-blue-600 text-white py-2 px-4 rounded-md shadow-sm hover:bg-blue-700 transition-colors"
          >
            Search
          </button>
        </div>
        <button
          onClick={downloadPDF}
          className="flex items-center gap-2 bg-gray-200 text-gray-800 py-2 px-4 rounded-md shadow-sm hover:bg-gray-300 transition-colors"
        >
