...
const NewInvoice = ({ invoice }) => {
  ...
  const data = {
    company: {
      ...
      contact: invoice.company_contact,
      gstin: invoice.company_gstin,
      CIN: invoice.company_cin,
    },
    buyer: {
      ...
      placeOfSupply: invoice.buyer_place_of_supply,
      contactPerson: invoice.buyer_contact_person,
    ...
    consignee: {
      ...
      contactPerson: invoice.consignee_contact_person,
      phone: invoice.consignee_phone,
      email: invoice.consignee_email,
    },
    invoice: {
      number: invoice.invoice_number,
      eWayBill: invoice.eway_bill_number,
      referenceNo: invoice.reference_number,
    ...
    taxAmount: parseFloat(invoice.tax_amount).toLocaleString("en-IN", {
      minimumFractionDigits: 2,
      maximumFractionDigits: 2,
    }),
    total: parseFloat(invoice.grand_total).toLocaleString("en-IN", {
      minimumFractionDigits: 2,
      maximumFractionDigits: 2,
    }),
    amountInWords: invoice.amount_in_words,
    taxAmountInWords: invoice.tax_amount_in_words,
    terms: invoice.terms ? JSON.parse(invoice.terms) : [],
    bank: {
      accountHolderName: invoice.bank_account_holder,
      name: invoice.bank_name,
      accountNo: invoice.bank_account_number,
      branch: invoice.bank_branch_ifsc,
    },
  };
          ...
          <tbody>
            <tr>
              ...
              >
                ...
                <div>E-Mail : {data.consignee.email}</div>
              </td>
            </tr>
          </tbody>
        </table>
            ...
            {data.items.map((item, index) => (
              <tr key={index}>
                ...
                >
                  {data.taxRate}% /{" "}
                  {formatCurrency(
                    (parseFloat(item.amount) * parseFloat(data.taxRate)) / 100,
                  )}
                </td>
                <td
                  style={{
