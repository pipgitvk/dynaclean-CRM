...
export default function AvailableStockModal({ isOpen, onClose }) {
  ...
  async function exportToXLS() {
    ...
    const worksheet = workbook.addWorksheet("Available Stock");

    worksheet.columns = [
      { header: "Product Code", key: "product_code", width: 20 },
      { header: "Product Image", key: "product_image", width: 20 },
    ...
    a.href = url;
    a.download = "available_stock.xlsx";
    a.click();
  ...
  return (
    ...
    >
      <div 
        className="bg-white p-6 rounded-xl shadow-lg w-full max-w-7xl max-h-[90vh] overflow-y-auto relative"
          ...
          <table className="min-w-full text-sm border border-gray-300 rounded">
            ...
            <tbody>
              {filteredData.map((row, idx) => (
                <tr key={(row.product_code ?? "code") + "_" + idx} className="border-t">
