...
export default function UploadBookingForm({
  order,
  isEditMode = false,
  redirectPath = "/admin-dashboard/order",
  initialBooking = null,
}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(
        isEditMode
          ? "Booking updated successfully. Confirmation email sent to customer."
          : "Booking uploaded successfully. Email sent to customer.",
      );
      setTimeout(() => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-8">
      <h1 className="text-2xl font-bold mb-2 text-center">
        {isEditMode ? "Edit Booking Details" : "Upload Booking"}
      </h1>
      {isEditMode && (
        <p className="text-sm text-gray-600 text-center mb-6">
          Changes will be saved and a booking confirmation email will be sent again to the client.
        </p>
      )}
