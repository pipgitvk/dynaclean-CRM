...
export default function MetaSyncLogsPage() {
  ...
  useEffect(() => {
    fetchLogs();
    fetchCredentials();
  }, [filterCredential, startDate, endDate]);
  ...
  const fetchLogs = async () => {
    try {
      ...
      if (filterCredential) {
        params.append('credentialId', filterCredential);
      }
      if (startDate) {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <Link
          href="/admin-dashboard/meta-dashboard"
        ...
        <p className="text-gray-600">View detailed history of Meta lead synchronization</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        {logs.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500">Sync logs will appear here after running lead synchronization</p>
          </div>
        ) : (
