...
export default function HROperationsPage() {
  ...
  const fetchEmployees = async () => {
    try {
      ...
      if (data?.success) {
        ...
        // Fallback: try to fetch from rep_list via API
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await res.json();
      if (data.success) {
        alert("Paid leave added successfully");
        setShowForm(false);
  ...
  const handleHalfDaySubmit = async (e) => {
    ...
    try {
      ...
      const data = await res.json();
      if (data.success) {
        alert("Half-day paid leave added successfully");
      ...
      <div className="p-6 max-w-2xl mx-auto">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          ...
          <p className="text-red-800 font-medium">
            Access Denied. Only SUPERADMIN can access HR Operations.
          </p>
          <Link
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-2">Add paid leaves for employees</p>
        </div>
      </div>
      ...
      {/* Leaves Added History */}
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-4 bg-gray-50 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-800">Leaves Added via HR Operations</h2>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full">
            ...
            <form onSubmit={handleHalfDaySubmit} className="p-6 space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
                ...
                >
                  {submitting ? "Adding..." : "Add Half-Day"}
                </button>
              </div>
            </form>
          </div>
