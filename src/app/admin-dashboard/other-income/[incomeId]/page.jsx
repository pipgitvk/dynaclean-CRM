...
export default async function AdminOtherIncomeDetailPage({ params }) {
    ...
    <div className="max-w-5xl mx-auto p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <Link href="/admin-dashboard/other-income" className="p-2 hover:bg-gray-100 rounded">
            <ArrowLeft size={24} />
          </Link>
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Other Income Details</h1>
            <p className="text-sm text-gray-600 mt-1">User: <span className="font-semibold">{income.username}</span></p>
          </div>
        </div>
        <span
      ...
      <div className="mt-6">
        <Link
          href="/admin-dashboard/other-income"
          className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800"
        >
          <ArrowLeft size={18} />
