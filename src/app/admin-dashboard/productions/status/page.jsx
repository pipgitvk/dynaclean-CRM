              ...
              <tr key={r.production_id} className="border-t">
                ...
                <td className="p-2 space-y-1">
                  <button
                    ...
                    onClick={() => router.push(`/admin-dashboard/productions/status/${encodeURIComponent(r.production_id)}/process`)}
                  >
                    Process
                  </button>
                  <button
                    className="text-amber-600 underline block text-left"
                    onClick={() => router.push(`/admin-dashboard/productions/status/${encodeURIComponent(r.production_id)}/update-bom`)}
                  >
                    Update BOM
                  </button>
                </td>
