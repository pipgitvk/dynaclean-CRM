...
import ScheduleVisitForm from "@/app/user-dashboard/view-customer/[customerId]/schedule-visit/ScheduleVisitForm";

export const dynamic = "force-dynamic";

export default async function AdminScheduleVisitPage({ params }) {
