    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mb-4 px-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/accounts-dashboard/purchase-products/add"
                    ...
                    >
                      ...
                      <td className="px-3 py-3">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <Link
                            href={`/accounts-dashboard/purchase-products/add?edit=true&invoice=${purchase.invoice_no}`}
          ...
          >
            <button
              onClick={() => {
                ...
                if (purchase) {
                  const editUrl = `/accounts-dashboard/purchase-products/add?edit=true&invoice=${encodeURIComponent(purchase.invoice_no)}`;
