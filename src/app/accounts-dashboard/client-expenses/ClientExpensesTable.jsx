    ...
    >
      ...
      <td className="p-3">
        <div className="flex gap-1.5 items-center">
          <Link href={`/accounts-dashboard/client-expenses/${row.id}`} className="p-2 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700 transition-colors" title="View">
            <Eye size={16} />
          </Link>
        </div>
      </td>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {groupHasSubHeads && client && (
              <button
                ...
                onClick={() =>
                  router.push(
                    `/accounts-dashboard/client-expenses/sub-head-cards?client=${encodedClient}&group=${encodedGroup}`,
                  )
                }
                className="inline-flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 shadow-sm hover:shadow transition-all w-full sm:w-auto"
              >
            ...
            <button
              type="button"
              onClick={() => router.push("/accounts-dashboard/client-expenses/cards")}
              className="inline-flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 shadow-sm hover:shadow transition-all w-full sm:w-auto"
            >
              <ArrowLeft size={16} />
              Back
          ...
          <div key={row.id} className="border border-gray-200 rounded-xl p-4 shadow-md bg-white text-sm space-y-2 hover:shadow-lg transition-shadow">
            ...
            <div className="pt-3 border-t border-gray-100 flex justify-between items-center">
              ...
              <div className="flex gap-1.5">
                <Link href={`/accounts-dashboard/client-expenses/${row.id}`} className="p-2 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100" title="View"><Eye size={16} /></Link>
              </div>
            </div>
          </div>
        ))}
