    ...
    try {
      ...
      if (res.ok) {
        ...
        if (initialClient) {
          ...
          router.push(`/accounts-dashboard/client-expenses/sub-head-cards?client=${encodeURIComponent(initialClient)}&group=${groupParam}`);
        } else {
          router.push("/accounts-dashboard/client-expenses/cards");
        }
      } else {
