    ...
    >
      ...
      <td className="p-3">
        <div className="flex gap-1.5 items-center">
          <Link href={`/accounts-dashboard/delivery-challan/${row.id}/edit`} className="p-2 rounded-lg bg-green-50 text-green-600 hover:bg-green-100 hover:text-green-700 transition-colors" title="Edit">
            <Edit size={16} />
          </Link>
          <Link href={`/accounts-dashboard/delivery-challan/${row.id}`} className="p-2 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700 transition-colors" title="View">
            <Eye size={16} />
          </Link>
        </div>
      </td>
          ...
          : 0}</div>
            ...
            <div className="pt-3 border-t border-gray-100 flex justify-end items-center">
              <div className="flex gap-1.5">
                <Link href={`/accounts-dashboard/delivery-challan/${row.id}/edit`} className="p-2 rounded-lg bg-green-50 text-green-600 hover:bg-green-100" title="Edit"><Edit size={16} /></Link>
                <Link href={`/accounts-dashboard/delivery-challan/${row.id}`} className="p-2 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100" title="View"><Eye size={16} /></Link>
              </div>
            </div>
          </div>
        ))}
