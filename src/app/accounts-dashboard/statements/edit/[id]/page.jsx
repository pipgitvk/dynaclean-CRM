...
export default function EditStatementPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.refresh();
      router.push("/accounts-dashboard/statements");
    } catch (e) {
          ...
          onChange={(e) => {
            ...
            if (value === "invoices") {
              if (userRole.includes("ACCOUNTANT") || userRole === "USER") {
                ...
                router.push("/accounts-dashboard/statements/invoices");
              }
            } else if (value === "purchase_billings") {
              router.push("/accounts-dashboard/statements/purchase-billings");
              ...
              router.push("/accounts-dashboard/client-expenses/employee-cards");
            } else {
