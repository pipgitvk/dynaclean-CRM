  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        ...
        <Link
          href="/accounts-dashboard/statements/add"
        ...
        <table className="min-w-full table-auto text-sm">
          <thead className="bg-gray-100 sticky top-0 z-10">
            <tr className="text-left font-semibold text-gray-700">
              ...
              <th
                className="p-2 w-[1%] max-w-[5.5rem] text-[11px] leading-snug whitespace-normal"
                title="Invoice, Purchases, DD, Expense"
              >
                Inv / Pur / DD / Exp
              </th>
              <th
            ...
            {sortedRows.length > 0 ? (
              sortedRows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="p-2 w-[1%] max-w-[5.5rem] align-top whitespace-nowrap">
                  ...
                  <td className="p-3 flex gap-2 items-center">
                    ...
                    <Link
                      href={`/accounts-dashboard/statements/edit/${row.id}`}
        ...
        {sortedRows.map((row) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <Link href={`/accounts-dashboard/statements/edit/${row.id}`} className="text-yellow-600 hover:text-yellow-800">
                <Pencil size={16} /> Edit
              </Link>
            </div>
          </div>
              ...
              <div>
                ...
                {banks.length === 0 && (
                  <p className="text-xs text-amber-600 mt-1">
                    No banks found. <a href="/accounts-dashboard/bank-masters" className="underline font-medium">Add a bank first →</a>
                  </p>
                )}
              </div>
