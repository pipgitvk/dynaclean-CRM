...
export async function POST(req) {
    console.log("POST /api/direct-in started");
    ...
    try {
        ...
        try {
            // 1. Insert into product_stock_request with status 'fulfilled'
      ...
      `;
            ...
            return NextResponse.json({
                success: true,
                message: "Direct stock entry created successfully",
                requestId: requestId
            });
        ...
        console.error("Error creating direct stock entry:", error);
        return NextResponse.json(
            { error: "Failed to create direct stock entry" },
            { status: 500 }
        );
    }
}
