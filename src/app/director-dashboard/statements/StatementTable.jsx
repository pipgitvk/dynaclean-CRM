  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        ...
        <Link
          href="/director-dashboard/statements/add"
              ...
              sortedRows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="p-3 flex gap-2 items-center">
                    ...
                    <Link
                      href={`/director-dashboard/statements/edit/${row.id}`}
        ...
        {sortedRows.map((row) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <Link href={`/director-dashboard/statements/edit/${row.id}`} className="text-yellow-600 hover:text-yellow-800">
                <Pencil size={16} /> Edit
              </Link>
            </div>
          </div>
              ...
              <div>
                ...
                {banks.length === 0 && (
                  <p className="text-xs text-amber-600 mt-1">
                    No banks found. <a href="/director-dashboard/bank-masters" className="underline font-medium">Add a bank first →</a>
                  </p>
                )}
              </div>
