...
export default function EditStatementPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.refresh();
      router.push("/director-dashboard/statements");
    } catch (e) {
        ...
        <select
          ...
          onChange={(e) => {
            ...
            if (value === "invoices") {
              ...
              router.push("/director-dashboard/statements/purchase-billings");
              ...
              router.push("/director-dashboard/client-expenses/employee-cards");
            } else {
