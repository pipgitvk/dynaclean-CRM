...
function buildByCreatorHref(name, sp) {
  const base = `/director-dashboard/prospects/by-creator/${encodeURIComponent(name)}`;
...
export default function ProspectsListCard({
  ...
  useEffect(() => {
    ...
    const base = lockedCreatorName
      ? `/director-dashboard/prospects/by-creator/${encodeURIComponent(lockedCreatorName)}`
      : "/director-dashboard/prospects";
    const qs = p.toString();
  ...
  const navigateToAddFromSuggestion = useCallback(
    (s) => {
      ...
      router.push(`/director-dashboard/prospects/new?customers=${q}${quoteQs}`);
    },
    [router],
  );
    ...
    return (
      <>
        ...
        <div className="mb-4 flex flex-wrap items-center gap-3">
          <Link
            href="/director-dashboard/prospects/add-manual"
                  ...
                  >
                    ...
                    <td className="whitespace-nowrap px-2 py-2.5 sm:px-4 sm:py-3">
                      <div className="flex items-center gap-1 sm:gap-1.5">
                        {canEdit ? (
                          <Link
                            href={`/director-dashboard/prospects/${row.id}/edit`}
