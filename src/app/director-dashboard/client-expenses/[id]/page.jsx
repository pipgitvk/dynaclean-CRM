  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between mt-10">
        <Link
          href={fromStatements ? "/director-dashboard/statements" : "/director-dashboard/client-expenses/cards"}
        ...
        <div className="flex gap-3">
          <Link
            href={`/director-dashboard/client-expenses/edit/${id}`}
          ...
          <ClientExpenseDeleteButton
            id={id}
            backHref={fromStatements ? "/director-dashboard/statements" : "/director-dashboard/client-expenses/cards"}
          />
        </div>
      </div>
    </div>
