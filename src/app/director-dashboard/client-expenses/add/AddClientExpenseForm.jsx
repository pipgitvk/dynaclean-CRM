    ...
    try {
      ...
      if (res.ok) {
        ...
        if (initialClient) {
          ...
          router.push(`/director-dashboard/client-expenses/sub-head-cards?client=${encodeURIComponent(initialClient)}&group=${groupParam}`);
        } else {
          router.push("/director-dashboard/client-expenses/cards");
        }
      } else {
