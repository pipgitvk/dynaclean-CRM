...
const QAPage = () => {
  ...
  const availableTags = isAdmin ? allTags : [userRole];
  ...
  const filteredQuestions = questions.filter((q) => {
    ...
    // Role-based filter: Employees only see questions matching their role, Admins see all
    const matchesRole = isAdmin || q.tags.includes(userRole);
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="flex gap-4 flex-wrap">
            ...
            <div className="flex gap-2">
              ...
              >
                <option value="">{isAdmin ? "All Tags" : "My Questions"}</option>
