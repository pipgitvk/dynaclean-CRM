...
All disputes shall be subject to jurisdiction of the courts at Delhi.`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("/api/amc-cmc", {
        method: "POST",
        body: formDataToSend,
      });
      ...
      toast.success("AMC/CMC request submitted successfully");
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h1 className="text-3xl font-bold mb-2">Submit AMC/CMC Request</h1>
        <p className="text-gray-600 mb-6">Fill in the details below to submit your AMC/CMC contract request for approval.</p>
              ...
              <div className="md:col-span-2">
                ...
                {files.image_at_the_time_of_amc && (
                  <p className="text-sm text-green-600 mt-1">
                    File selected: {files.image_at_the_time_of_amc.name}
                  </p>
                )}
              </div>
            </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                />
                {files.invoice && (
                  <p className="text-sm text-green-600 mt-1">File selected: {files.invoice.name}</p>
                )}
              </div>
              <div>
                ...
                {files.payment_proof && (
                  <p className="text-sm text-green-600 mt-1">
                    File selected: {files.payment_proof.name}
                  </p>
                )}
              </div>
              <div className="md:col-span-2">
