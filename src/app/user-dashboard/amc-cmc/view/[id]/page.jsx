...
export default function ViewUserAMCCMCPage() {
  ...
  // Returns correct URL — Cloudinary URLs pass through, local files get /uploads/ prefix
  ...
  // Opens file in new tab — Cloudinary goes through proxy, others open directly
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {record.image_at_the_time_of_amc && (
                <div className="md:col-span-2">
                  <p className="text-sm text-gray-600 mb-2">Image</p>
                  <img
                    src={`/amc_cmc/${record.image_at_the_time_of_amc}`}
                    alt="AMC Image"
                    className="max-w-xs rounded-lg"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {record.payment_proof && (
                <div>
                  ...
                  <a
                    href={`/amc_cmc/${record.payment_proof}`}
                    target="_blank"
                    className="text-blue-600 hover:text-blue-800 underline"
                  >
                    View Payment Proof
