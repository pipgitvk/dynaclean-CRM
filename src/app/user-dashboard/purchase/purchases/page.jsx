...
function LinkPaymentModal({ open, onClose, purchase, onLinked, currentStatementId }) {
  ...
  const eligibleStatements = useMemo(() => {
    ...
    const myKey = Number.isFinite(pid) && pid > 0 ? `PP${pid}` : "";
  ...
  async function linkToStatement(statementId, transId) {
    try {
      ...
      const res = await fetch(`/api/statements/${statementId}`, {
        ...
        credentials: "include",
        body: JSON.stringify({ purchase_id: purchase.id, purchase_type: "PP" }),
      });
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`px-3 py-1.5 text-sm rounded ${statusFilter === "all"
              ...
              <button
                ...
                className={`px-3 py-1.5 text-sm rounded ${statusFilter === "requested"
              ...
              <button
                ...
                className={`px-3 py-1.5 text-sm rounded ${statusFilter === "in_warehouse"
                  ? "bg-blue-600 text-white"
                  : "bg-gray-200 text-gray-800 hover:bg-gray-300"
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 text-sm rounded ${statusFilter === "fulfilled"
                  ...
                  <tr key={purchase.id} className="border-t hover:bg-gray-50">
                    ...
                    <td className="p-3">
                      ...
                      <button
                        ...
                        className={`ml-2 ${purchase.status !== 'requested' ? 'text-gray-400 cursor-not-allowed' : 'text-purple-600 hover:underline'} text-sm`}
                      >
                        Edit
                      </button>
                      <button
                ...
                return (
                  <div>
                    ...
                    <div className="w-full h-2 rounded bg-gray-200">
                      <div className={`h-2 rounded ${idx === 0 ? 'bg-yellow-500' : idx === 1 ? 'bg-blue-500' : 'bg-green-600'}`} style={{ width: percent + '%' }} />
                    </div>
                  </div>
                );
              })()}
            ...
            <div className="p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  ["Product Image", detailPurchase.product_image],
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-2">
              <h4 className="font-semibold">Product Image Preview</h4>
