                  ...
                  <tr key={row.service_id} className={bgColorClass}>
                    ...
                    <td className="p-2 border border-gray-300 space-y-1">
                      {row.status !== "COMPLETED" && (
                        <a
                          href={`/user-dashboard/warranty/service-records/update/${row.service_id}`}
                      ...
                      <a
                        href={`/user-dashboard/warranty/service-records/service-report/${row.service_id}`}
                      ...
                      {row.status === "COMPLETED" &&
                        Number(row.company_cost) === 0 && (
                          <a
                            href={`/user-dashboard/warranty/service-records/cost/${row.service_id}`}
