...
import { LogIn, Key, Edit } from "lucide-react";
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6">
      ...
      <Link
        ...
        className="text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 inline-block mb-4"
      >
        Add Employee
      </Link>
                  ...
                  <tr key={employee.empId}>
                    ...
                    {/* <td className="px-6 py-4">
                      <div className="flex gap-4">
                        ...
                        <Link
                          href={`/user-dashboard/password/${employee.username}`}
                        ...
                        <Link
                          href={`/user-dashboard/quick-edit/${employee.username}`}
