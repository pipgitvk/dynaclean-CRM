...
export default function DashboardPage() {
  ...
  const [currentUser, setCurrentUser] = useState(null); // { username, userRole }
  ...
  // Load current user and, if needed, lock the employee filter to them
  useEffect(() => {
    async function loadCurrentUser() {
      try {
        ...
        console.error("Failed to load current user in today-reports", e);
      }
    }
